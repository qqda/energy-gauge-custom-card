...
import { EnergyGaugeCustomCardConfig, Severities } from './energy-gauge-custom-card-config';
...
registerCustomCard({
  type: 'energy-gauge-custom-card',
  name: 'Energy Gauge Custom Card',
  description: 'A collection of gauges for energy monitoring',
});
@customElement('energy-gauge-custom-card')
export class EnergyGaugeCustomCard extends SubscribeMixin(LitElement) implements LovelaceCard {
  ...
  public static async getConfigElement(): Promise<LovelaceCardEditor> {
    ...
    return document.createElement('energy-gauge-custom-card-editor');
  }
  ...
  public setConfig(config: EnergyGaugeCustomCardConfig): void {
    this._config = config;
  }
  ...
  protected render() {
    ...
    let k: keyof EnergyGaugeCustomCardConfig;
...
declare global {
  interface HTMLElementTagNameMap {
    'energy-gauge-custom-card': EnergyGaugeCustomCard;
  }
}
